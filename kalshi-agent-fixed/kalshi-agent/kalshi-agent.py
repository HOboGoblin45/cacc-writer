    ...
    def check_positions(self):
        ...
        for pos in positions:
            ...
            try:
                ...
                log.debug(f"Could not parse entry time: {e}")
...
def calc_hours_left(m):
    ...
    try:
        ...
        log.debug(f"Could not parse close time: {e}"); return 9999
    ...
    def __init__(self):
        ...
        for t in self.trades:
            try:
                ...
                log.debug(f"Skipping malformed trade record: {e}")
    def _save(self):
...
def main():
    ...
    env_overrides = {
        ...
        "KALSHI_EMAIL_FROM": "email_from",
        "KALSHI_EMAIL_PASSWORD": "email_password",
        "KALSHI_EMAIL_TO": "email_to",
