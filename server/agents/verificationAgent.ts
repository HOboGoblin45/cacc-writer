 ...
 */
export async function verifyInsertion(state: WorkflowState): Promise<VerificationResult> {
 ...
 */
export async function retryInsertion(state: WorkflowState): Promise<InsertionResult> {
 ...
 */
export function getSoftwareForForm(formType: string): 'aci' | 'real_quantum' {
