 ...
 */
export type PipelineStage = 'create_case' | 'parse_documents' | 'extract_facts' | 'retrieve_examples' | 'draft_section' | 'review_section' | 'insert_section' | 'verify_insert' | 'save_output' | 'complete' | 'failed';
